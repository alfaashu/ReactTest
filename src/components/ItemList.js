            ...
            {items.map(item => (
                <div key={item.card.info.id} className="p-2 m-2 border-b-1 text-left flex justify-between">
                    ...
                    <div className="w-3/12 relative">
                        <button className="px-10 py-1  bg-white shadow-lg absolute rounded-lg border-1 font-bold text-green-500 bottom-0 left-1/2 transform -translate-x-1/2">ADD</button>
